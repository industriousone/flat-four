/*
** $Id: lapi.c,v 1.3 2002/04/25 01:19:30 jason379 Exp $
** Lua API
...
// 379: F4 friendly dofile() function
extern int _f4DoFile(lua_State* L, const char* filename);
