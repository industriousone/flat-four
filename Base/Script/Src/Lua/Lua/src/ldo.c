/*
** $Id: ldo.c,v 1.2 2002/04/22 01:51:55 jason379 Exp $
...
// 379: this is called to report scripting errors
extern void _f4Error(lua_State* L, const char* msg);
...
void luaD_error (lua_State *L, const char *s) {
  // 379: prevent call to _ERRORMESSAGE, which loses context of error
  _f4Error(L, s);
//  if (s) message(L, s);
