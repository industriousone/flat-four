/*
** $Id: lbaselib.c,v 1.2 2002/04/22 01:51:55 jason379 Exp $
** Basic library
...
// 379: use the engine logging function instead of fputs()
extern void _f4Printer(const char* msg);
#define fputs(m,s) _f4Printer(m)
...
static int luaB_print (lua_State *L) {
  ...
  for (i=1; i<=n; i++) {
    ...
    // 379: get rid of tabs between objects, ugly I think
	// if (i>1) fputs("\t", stdout);
	if (i>1) fputs(" ", stdout);
...
// 379: make this accessible to F4 extensions
//static 
