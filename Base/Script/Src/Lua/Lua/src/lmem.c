/*
** $Id: lmem.c,v 1.2 2002/04/22 01:51:55 jason379 Exp $
...
// 379: use F4 memory manager
void* _f4Realloc(void* ptr, size_t size);
void  _f4Free(void* ptr);
#define l_realloc(b,os,s)   _f4Realloc(b,s)
#define l_free(b,s)         _f4Free(b)
